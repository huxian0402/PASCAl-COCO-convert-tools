# convert NWPUcsv to COCO for airplane class
...
def generate_xml(name, lines, img_size = (1066, 588, 1),
                 class_sets = ('airplane'), doncateothers = True):
    """
