# convert NWPU to CSV
# cls: 1-10 ---  0-9
# 'airplane':0,'ship':1,'storage_tank':2,'baseball_diamond':3,'tennis_court':4,'basketball_court':5,'ground_track_field':6,
...
def write_CSV(txt_list, output_path, start_index):
    for i in range(len(txt_list)):
        ...
        for m in range(len(boxes)):  # 10 cls
            txt_label.write(
                '{},{},{},{},{}\n'.format(boxes[m][4], boxes[m][0], boxes[m][1], boxes[m][2], boxes[m][3]))
        txt_label.close()

data_txt_path = './NWPU_Data/ground truth/'
data_posimg_path = './NWPU_Data/positive image set/'
...
# train
train_outpath = './NWPU_CSV/train/'
val_outpath = './NWPU_CSV/val/'
test_outpath = './NWPU_CSV/test/'
